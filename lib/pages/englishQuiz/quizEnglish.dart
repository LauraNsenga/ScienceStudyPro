...
import 'package:shop_ease/pages/englishQuiz/phys.quiz.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all(Colors.lightGreen[300]), // Set button color to light green
              ),
              child: Text(
                'Biology Quiz',
