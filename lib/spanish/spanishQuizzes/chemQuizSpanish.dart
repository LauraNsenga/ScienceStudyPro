...
class PaginaQuizQuimica extends StatefulWidget {
  @override
  _PaginaQuizQuimicaState createState() =>  _PaginaQuizQuimicaState();
}

class   _PaginaQuizQuimicaState extends State<PaginaQuizQuimica> {
  final List<Map<String, String>> quizData = [
    ...
    {
      'question': '¿Para qué sirve la escala de pH?',
      'answer': 'Medir la acidez o alcalinidad de una sustancia',
    },
    {
    ...
    {
      'question': '¿Cómo se llama al proceso de división de átomos?',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Cuestionario de Química'),
